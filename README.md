# AeroFetch · 抖音 / TikTok / X 无水印高清解析下载

一个开箱即用的全栈 Web 应用：粘贴抖音、TikTok 或 X (Twitter) 分享链接，解析出无水印高清视频、图集与背景音乐，并通过后端代理流式下载到本地。

## 支持平台

| 平台 | 视频 | 图集 | 音频提取 | 短链 |
| ---- | :--: | :--: | :--: | ---- |
| 抖音 (Douyin) | ✅ 无水印 HQ | ✅ + ZIP 打包 | ✅ | `v.douyin.com` |
| TikTok | ✅ 无水印 HQ | ✅ + ZIP 打包 | ✅ | `vt.tiktok.com` / `vm.tiktok.com` |
| X (Twitter) | ✅ 最高码率 | ✅ 原图 + ZIP | ✅ (ffmpeg) | `t.co` |
| YouTube | 🚧 规划中 | — | — | — |

## 功能特性

- **多平台解析**：支持短链重定向与分享文本中夹杂链接的提取
